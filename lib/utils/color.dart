...
const primaryColor = Color(0xffEC008C);

const primaryDarkColor = Color(0xff0e0e16);
const accentColor = Color(0xffffffff);

const complimentryColor = Color(0xffFA3457);
const primaryLight = Color(0xffF980C8);
const primaryDark = Color(0xdbf980c8);
const primaryTras75 = Color(0xdbf980c8);
const primaryTras50 = Color(0xa9f980c8);
const primaryTras25 = Color(0x52f980c8);
const primaryTras10 = Color(0x32f980c8);
const primaryTras5 = Color(0xff980c8);
