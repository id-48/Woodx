...
import 'package:wood_vip/model/sectiondetailmodel.dart';
import 'package:wood_vip/pages/castdetails.dart';
import 'package:wood_vip/pages/loginsocial.dart';
import 'package:wood_vip/pages/moviedetails.dart';
import 'package:wood_vip/pages/showdetails.dart';
...
import 'package:wood_vip/subscription/subscription.dart';
import 'package:wood_vip/tvpages/tvmoviedetails.dart';
import 'package:wood_vip/utils/color.dart';
import 'package:wood_vip/utils/constant.dart';
import 'package:wood_vip/utils/dimens.dart';
import 'package:wood_vip/utils/strings.dart';
import 'package:wood_vip/utils/utils.dart';
import 'package:wood_vip/webwidget/footerweb.dart';
import 'package:wood_vip/widget/episodebyseason.dart';
import 'package:wood_vip/widget/moredetails.dart';
import 'package:wood_vip/widget/myimage.dart';
import 'package:wood_vip/widget/mynetworkimg.dart';
import 'package:wood_vip/widget/mytext.dart';
import 'package:wood_vip/widget/myusernetworkimg.dart';
  ...
  Widget _buildTabs() {
    return Column(
      ...
      children: [
        ...
        /* Data */
        if (showDetailsProvider.tabClickedOn == "related")
          Column(
            mainAxisSize: MainAxisSize.max,
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              if (widget.videoType != 5 &&
                  ...
                  (showDetailsProvider.sectionDetailModel.session?.length ??
                          0) >
                      0)
                Container(
                  width: MediaQuery.of(context).size.width,
